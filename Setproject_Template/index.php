...
<body>
    ...
    <nav class="navbar navbar-expand-lg -dark bg-dark">
        ...
        <img src="./assets/img/logo.jpg" width="70px" height="70px" class="img-thumbnail">
            <H2 class="navbar-brand text-light h2 mt-0 mb-1" href="index.html">
                  Dreg Skateshop
            </H2>
    ...
    <section class="container py-5">
        <div class="row text-center pt-3">
            <div class="col-lg-6 m-auto">
                <h1 class="h1">สินค้าใหม่</h1>
                <p>
                    สินค้าใหม่ที่กำลังมาแรง
                </p>
            </div>
        </div>
        <div class="row">
